...
</style></head><body><main class="hero"><section class="content" style="padding:18px 22px;max-width:780px"><p class="eyebrow" style="margin-bottom:5px">Bing · 每日壁纸</p><h1 style="font-size:clamp(1.25rem,3vw,2.2rem);margin-bottom:4px">${title}</h1><p class="copyright" style="font-size:.82rem;line-height:1.35">${copyright}</p><div class="meta" style="margin-top:7px"><span>📅 ${date}</span></div><div class="actions" style="margin-top:10px"><a class="button" href="/image" download="bing-wallpaper.jpg">下载原图</a><a class="button secondary" href="${source}" target="_blank" rel="noopener">图片来源</a></div></section></main></body></html>`;
}
