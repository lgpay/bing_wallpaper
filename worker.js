...
function renderPage(wallpaper) {
  ...
  return `<!doctype html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="${title} - Bing 每日壁纸"><link rel="icon" href="https://www.bing.com/sa/simg/favicon-2x.ico"><title>${title} · Bing 每日壁纸</title><style>
